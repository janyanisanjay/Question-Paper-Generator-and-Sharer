...
if(isset($_POST["create_pdf"]))  
 {  
      ...
      <table border="1" cellspacing="0" cellpadding="5">
        ...
        <th width="20%"><h4>Marks</h4></th>mit
        </tr>  
      ';  
      $content .= fetch_data();  
      $content .= '</table>';  
...
<!--                            <div class="col-md-10">-->
                                <button style="margin-left:500px;margin-bottom:0px;"type="Submit" name="create_pdf"class="btn btn-info btn-lg">Download as Pdf</button>
<!--                            </div>-->
                    </div> 
                    </div>    
                </form>
